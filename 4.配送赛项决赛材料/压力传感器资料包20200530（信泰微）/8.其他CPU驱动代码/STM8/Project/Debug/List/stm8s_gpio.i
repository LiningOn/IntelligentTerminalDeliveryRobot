#line 1 "C:\\Users\\SDMSJY\\Desktop\\\301\372\261\363\273\324\\\306\370\261\303\\STM8\\FWlib\\src\\stm8s_gpio.c"
/**
  ******************************************************************************
  * @file    stm8s_gpio.c
...
/* Includes ------------------------------------------------------------------*/
#line 1 "C:\\Users\\SDMSJY\\Desktop\\\301\372\261\363\273\324\\\306\370\261\303\\STM8\\Project\\..\\FWlib\\inc\\stm8s_gpio.h"
/**
  ******************************************************************************
  * @file    stm8s_gpio.h
  * @author  MCD Application Team
...
/* Define to prevent recursive inclusion -------------------------------------*/
#line 148 "C:\\Users\\SDMSJY\\Desktop\\\301\372\261\363\273\324\\\306\370\261\303\\STM8\\FWlib\\inc\\stm8s_gpio.h"
...
/**
  ...
  */
/******************* (C) COPYRIGHT 2011 STMicroelectronics *****END OF FILE****/
#line 28 "C:\\Users\\SDMSJY\\Desktop\\\301\372\261\363\273\324\\\306\370\261\303\\STM8\\Project\\..\\FWlib\\inc\\stm8s_gpio.h"
...
/**
  ...
  */
#line 117 "C:\\Users\\SDMSJY\\Desktop\\\301\372\261\363\273\324\\\306\370\261\303\\STM8\\Project\\..\\FWlib\\inc\\stm8s_gpio.h"
...
/******************* (C) COPYRIGHT 2011 STMicroelectronics *****END OF FILE****/
#line 24 "C:\\Users\\SDMSJY\\Desktop\\\301\372\261\363\273\324\\\306\370\261\303\\STM8\\FWlib\\src\\stm8s_gpio.c"
...
void GPIO_DeInit(GPIO_TypeDef* GPIOx)
{
    GPIOx->ODR = ((uint8_t)0x00); /* Reset Output Data Register */
    GPIOx->DDR = ((uint8_t)0x00); /* Reset Data Direction Register */
    GPIOx->CR1 = ((uint8_t)0x00); /* Reset Control Register 1 */
    GPIOx->CR2 = ((uint8_t)0x00); /* Reset Control Register 2 */
}
...
_Bool GPIO_ReadInputPin(GPIO_TypeDef* GPIOx, GPIO_Pin_TypeDef GPIO_Pin)
{
    return ((_Bool)(GPIOx->IDR & (uint8_t)GPIO_Pin));
}
...
void GPIO_ExternalPullUpConfig(GPIO_TypeDef* GPIOx, GPIO_Pin_TypeDef GPIO_Pin, _Bool NewState)
{
    ...
    if (NewState != 0) /* External Pull-Up Set*/
    {
        GPIOx->CR1 |= (uint8_t)GPIO_Pin;
