#line 1 "C:\\Users\\SDMSJY\\Desktop\\\301\372\261\363\273\324\\\306\370\261\303\\STM8\\FWlib\\src\\stm8s_exti.c"
/**
  ******************************************************************************
  * @file    stm8s_exti.c
...
/**
  ...
  */
/******************* (C) COPYRIGHT 2011 STMicroelectronics *****END OF FILE****/
#line 28 "C:\\Users\\SDMSJY\\Desktop\\\301\372\261\363\273\324\\\306\370\261\303\\STM8\\Project\\..\\FWlib\\inc\\stm8s_exti.h"
...
/******************* (C) COPYRIGHT 2011 STMicroelectronics *****END OF FILE****/
#line 24 "C:\\Users\\SDMSJY\\Desktop\\\301\372\261\363\273\324\\\306\370\261\303\\STM8\\FWlib\\src\\stm8s_exti.c"
...
void EXTI_DeInit(void)
{
    ((EXTI_TypeDef *) 0x50A0)->CR1 = ((uint8_t)0x00);
    ((EXTI_TypeDef *) 0x50A0)->CR2 = ((uint8_t)0x00);
}
...
void EXTI_SetExtIntSensitivity(EXTI_Port_TypeDef Port, EXTI_Sensitivity_TypeDef SensitivityValue)
{
    ...
    case EXTI_PORT_GPIOA:
        ((EXTI_TypeDef *) 0x50A0)->CR1 &= (uint8_t)(~((uint8_t)0x03));
        ((EXTI_TypeDef *) 0x50A0)->CR1 |= (uint8_t)(SensitivityValue);
        break;
    case EXTI_PORT_GPIOB:
        ((EXTI_TypeDef *) 0x50A0)->CR1 &= (uint8_t)(~((uint8_t)0x0C));
        ((EXTI_TypeDef *) 0x50A0)->CR1 |= (uint8_t)((uint8_t)(SensitivityValue) << 2);
        break;
    case EXTI_PORT_GPIOC:
        ((EXTI_TypeDef *) 0x50A0)->CR1 &= (uint8_t)(~((uint8_t)0x30));
        ((EXTI_TypeDef *) 0x50A0)->CR1 |= (uint8_t)((uint8_t)(SensitivityValue) << 4);
        break;
    case EXTI_PORT_GPIOD:
        ((EXTI_TypeDef *) 0x50A0)->CR1 &= (uint8_t)(~((uint8_t)0xC0));
        ((EXTI_TypeDef *) 0x50A0)->CR1 |= (uint8_t)((uint8_t)(SensitivityValue) << 6);
        break;
    case EXTI_PORT_GPIOE:
        ((EXTI_TypeDef *) 0x50A0)->CR2 &= (uint8_t)(~((uint8_t)0x03));
        ((EXTI_TypeDef *) 0x50A0)->CR2 |= (uint8_t)(SensitivityValue);
        break;
    default:
        break;
    }
...
void EXTI_SetTLISensitivity(EXTI_TLISensitivity_TypeDef SensitivityValue)
{
    ...
    ((EXTI_TypeDef *) 0x50A0)->CR2 &= (uint8_t)(~((uint8_t)0x04));
    ((EXTI_TypeDef *) 0x50A0)->CR2 |= (uint8_t)(SensitivityValue);
}
...
EXTI_Sensitivity_TypeDef EXTI_GetExtIntSensitivity(EXTI_Port_TypeDef Port)
{
    ...
    {
    case EXTI_PORT_GPIOA:
        value = (uint8_t)(((EXTI_TypeDef *) 0x50A0)->CR1 & ((uint8_t)0x03));
        break;
    case EXTI_PORT_GPIOB:
        value = (uint8_t)((uint8_t)(((EXTI_TypeDef *) 0x50A0)->CR1 & ((uint8_t)0x0C)) >> 2);
        break;
    case EXTI_PORT_GPIOC:
        value = (uint8_t)((uint8_t)(((EXTI_TypeDef *) 0x50A0)->CR1 & ((uint8_t)0x30)) >> 4);
        break;
    case EXTI_PORT_GPIOD:
        value = (uint8_t)((uint8_t)(((EXTI_TypeDef *) 0x50A0)->CR1 & ((uint8_t)0xC0)) >> 6);
        break;
    case EXTI_PORT_GPIOE:
        value = (uint8_t)(((EXTI_TypeDef *) 0x50A0)->CR2 & ((uint8_t)0x03));
        break;
    default:
        break;
    }
...
EXTI_TLISensitivity_TypeDef EXTI_GetTLISensitivity(void)
{
    ...
    value = (uint8_t)(((EXTI_TypeDef *) 0x50A0)->CR2 & ((uint8_t)0x04));
