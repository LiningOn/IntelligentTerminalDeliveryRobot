...
{
	Send_data(6,voice_3);	//播报：请取出2号物料，并关闭仓门
...
/*十字路口*/			
		...
		////////////////这里的参数是从红绿灯出发的//////////////			 			
					kp_angle=4;
					Speed_programme(Time_PATH1_Left, V_Turn_Left_Max , 0.2, 0.2, &Robot_target.Vx);
					vTaskDelay(100);	
					Robot_target.Vy = 0.0;
					Robot_target.Vx = 0.0;
					vTaskDelay(100);
			...
			////////////////这里的参数是从红绿灯出发的//////////////			 			
					kp_angle = 10;
					Robot_target.Vy=V_Forward_Little;			
					vTaskDelay(Time_Forward_Little + 120);										
					Robot_target.Vy=0.0;
					Robot_target.Vx=0.0;
					vTaskDelay(100);
			...
			////////////////这里的参数是从红绿灯出发的//////////////			 			
					kp_angle = 7;
					Speed_programme(Time_PATH2_Right, V_Turn_Right_Max , 0.2, 0.2, &Robot_target.Vx);
					vTaskDelay(100);	
					Robot_target.Vy = 0.0;
					Robot_target.Vx = 0.0;
					vTaskDelay(100);
...
/*返程*/				
			...
			////////////////这里的参数是从红绿灯出发的//////////////			 			
					kp_angle=4;
					Speed_programme(Time_PATH1_Right, V_Turn_Right_Max , 0.2, 0.2, &Robot_target.Vx);
					vTaskDelay(100); 	
			...
			////////////这里的参数是返程的////////////
					kp_angle = 7;					
					Speed_programme(Time_PATH2_Left, V_Turn_Left_Max , 0.2, 0.2, &Robot_target.Vx);
					vTaskDelay(100); 			
