...
/*前进*/
#define V_Forward_Max 				300.0		
#define V_Forward_Little 			200.0		
/*右移*/
#define V_Turn_Right_Max 		   -300.0	
/*左移*/
#define V_Turn_Left_Max 		    300.0	
/*后退*/
#define V_Back_Off_Max 			   -300.0
/*撞墙*/
...
/*前进到红绿灯口过程*/
#define Time_Forward_Long   		3000		//前进
#define Time_Forward_Little 		680			//前进一小段	

/*PATH1*/
#define Time_PATH1_Left 			1750		//左移	
#define Time_PATH1_Strike 			1200		//撞墙
#define Time_PATH1_Leave 			 500		//离墙
#define Time_PATH1_Right 			1830		//右移		
#define Time_PATH1_Back 			3750		//退后
#define Time_PATH1_Turn				 130		//复位

/*PATH2*/
#define Time_PATH2_Right 			1700		//右移
#define Time_PATH2_Strike 			1300		//撞墙
#define Time_PATH2_Leave 			 650		//离墙
#define Time_PATH2_Left 			2110		//左移
#define Time_PATH2_Back 			3700		//退后
#define Time_PATH2_Turn				 160		//复位
